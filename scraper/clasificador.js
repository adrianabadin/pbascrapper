 ...
 *   GROQ_API_KEY          — requerida (nuevo)
 *   GROQ_BASE_URL        — default https://api.groq.com/openai/v1
 *   OPENAI_API_KEY         — requerida (nuevo)
...
// Función auxiliar: clasificar con Zhipu
async function clasificarConZhipu(resumen, intento = 1) {
  if (!ZHIPU_API_KEY) throw new Error('ZHIPU_API_KEY no configurada');
...
// Función auxiliar: clasificar con Groq
...
// Función auxiliar: clasificar con OpenAI
